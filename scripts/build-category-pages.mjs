...
${siteFooter(lang)}
${searchDialog(lang)}
<script src="/data/tags.js"></script><script src="/data/posts.js"></script><script src="/assets/locale.js?v=a47c9d5cb9"></script><script src="/assets/site.js?v=82bcc9e041"></script><script src="/assets/category-landing.js?v=36b2a4df15"></script>
</body></html>
`;
}
