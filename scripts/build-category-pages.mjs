...
${siteFooter(lang)}
${searchDialog(lang)}
<script src="/data/tags.js"></script><script src="/data/posts.js"></script><script src="/assets/locale.js?v=9902203c1a"></script><script src="/assets/site.js?v=2ca5bdd0b5"></script><script src="/assets/category-landing.js?v=36b2a4df15"></script>
</body></html>
`;
}
