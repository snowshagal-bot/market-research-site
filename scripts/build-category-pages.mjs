...
${siteFooter(lang)}
${searchDialog(lang)}
<script src="/data/tags.js"></script><script src="/data/posts.js"></script><script src="/assets/locale.js?v=502679a63f"></script><script src="/assets/site.js?v=c0af2e1bed"></script><script src="/assets/category-landing.js?v=36b2a4df15"></script>
</body></html>
`;
}
