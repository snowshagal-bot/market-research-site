...
${siteFooter(lang)}
${searchDialog(lang)}
<script src="/data/tags.js"></script><script src="/data/posts.js"></script><script src="/assets/locale.js?v=25bbd4cdf0"></script><script src="/assets/site.js?v=fae35361d8"></script><script src="/assets/category-landing.js?v=36b2a4df15"></script>
</body></html>
`;
}
