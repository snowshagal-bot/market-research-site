...
${siteFooter(lang)}
${searchDialog(lang)}
<script src="/data/tags.js"></script><script src="/data/posts.js"></script><script src="/assets/locale.js?v=0fd9c0b1e3"></script><script src="/assets/site.js?v=141c35ac48"></script><script src="/assets/category-landing.js?v=36b2a4df15"></script>
</body></html>
`;
}
