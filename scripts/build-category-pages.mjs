...
function nav(lang) {
  const labels = lang === 'en'
    ? { market: 'Market', daily: 'Daily', weekly: 'Weekly', research: 'Research', basics: 'Market Basics', note: 'Notes' }
    : { market: '마켓', daily: '데일리', weekly: '위클리', research: '리서치', basics: '시장 공부', note: '끄적끄적' };
  const localePrefix = lang === 'en' ? '/en' : '';
  return `<a href="${localePrefix}/market/">${labels.market}</a>
...
<link rel="alternate" hreflang="ko" href="${PRODUCTION_ORIGIN}${koPath}"><link rel="alternate" hreflang="en" href="${PRODUCTION_ORIGIN}${enPath}"><link rel="alternate" hreflang="x-default" href="${PRODUCTION_ORIGIN}${koPath}">
...
<link rel="stylesheet" href="/assets/site.css"><link rel="stylesheet" href="/assets/brand.css?v=20260825-1"><link rel="stylesheet" href="/assets/language.css?v=20260812-1"><link rel="stylesheet" href="/assets/category-state.css"><link rel="stylesheet" href="/assets/ui-polish.css?v=20260811-1"><link rel="stylesheet" href="/assets/home-v2.css?v=20260827-1"><link rel="stylesheet" href="/assets/category-landing.css?v=20260827-1">
...
<main><section class="category-landing-hero"><div class="site-wrap"><p class="category-landing-eyebrow">${en ? 'ARCHIVE' : '카테고리 아카이브'}</p><h1>${escapeHtml(text.heading)}</h1><p class="category-landing-lead">${escapeHtml(text.lead)}</p></div></section><section class="category-landing-list-section" aria-labelledby="category-list-heading"><div class="site-wrap"><div class="category-landing-list-head"><h2 id="category-list-heading">${en ? 'Reports' : '리포트 목록'}</h2><a class="category-landing-home" href="${home}">${en ? 'All reports' : '전체 리포트'} <span aria-hidden="true">→</span></a></div><div id="category-report-list" class="report-list" data-category-report-list data-category="${type}"></div></div></section></main>
...
${searchDialog(lang)}
<script src="/data/tags.js?v=20260826-1"></script><script src="/data/posts.js?v=20260824-1"></script><script src="/assets/locale.js?v=20260827-3"></script><script src="/assets/site.js?v=20260827-4"></script><script src="/assets/category-landing.js?v=20260827-1"></script>
</body></html>
`;
}
