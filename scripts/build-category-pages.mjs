...
<main><section class="category-landing-hero"><div class="site-wrap"><p class="category-landing-eyebrow">${eyebrow}</p><h1>${escapeHtml(text.heading)}</h1><p class="category-landing-lead">${escapeHtml(text.lead)}</p></div></section><section class="category-landing-featured-section" id="category-featured-section" aria-labelledby="category-featured-heading"><div class="site-wrap"><div class="category-landing-list-head"><h2 id="category-featured-heading">${escapeHtml(featuredHeading)}</h2></div><div id="category-featured-cards" class="latest-cards" data-category-featured-cards></div></div></section><section class="category-landing-list-section" id="category-archive-section" aria-labelledby="category-list-heading"><div class="site-wrap"><div class="category-landing-list-head"><h2 id="category-list-heading">${en ? 'Previous Reports' : '지난 리포트'}</h2><a class="category-landing-home" href="${home}">${en ? 'All reports' : '전체 리포트'} <span aria-hidden="true">→</span></a></div><div id="category-report-list" class="report-list" data-category-report-list data-category="${type}"></div></div></section></main>
...
${searchDialog(lang)}
<script src="/data/tags.js?v=636e50700f"></script><script src="/data/posts.js"></script><script src="/assets/locale.js?v=c9e75896a6"></script><script src="/assets/site.js?v=b21afb2c92"></script><script src="/assets/category-landing.js?v=7c5a3e4624"></script>
</body></html>
`;
}
