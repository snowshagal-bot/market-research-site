...
export async function onRequest(context) {
  ...
  const shell = `<script src="/assets/locale.js?v=20260824-2"></script><script src="/assets/report-shell.js?v=20260827-2" data-category="${active}" data-lang="${lang}"></script>${engagement}`;
  let seo = '';
  try {
