...
export async function onRequest(context) {
  ...
  const shell = `<script src="/assets/locale.js?v=5d3b835c3b"></script><script src="/assets/report-shell.js?v=5d566fd0c8" data-category="${active}" data-lang="${lang}" data-notes="${hasNotes ? '1' : '0'}"></script>${engagement}`;
