      ...
      return `
        <article class="disclosure-card priority-${priorityClass}" data-rcept-no="${rceptNo}">
          <div class="disclosure-card-main">
            ...
            <h3 class="disclosure-report-title">${html(item.reportName)}</h3>
            <div class="disclosure-card-actions">
              <a class="disclosure-dart-btn" href="${html(item.sourceUrl)}" target="_blank" rel="noopener noreferrer" aria-label="DART 전자공시 원문 열기">
                ${copy.dartOriginal}
              </a>
              ${hasAi ? `
